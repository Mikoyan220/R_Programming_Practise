...
```{r load data}
hotel_bookings <- read.csv("C:/Users/user/Documents/Code/RStudio/dataset_hotel_bookings.csv")
```
...
```{r save your plot in 7x7 default size, echo=FALSE}
...
```{r save your plot in defined size, echo=FALSE}
